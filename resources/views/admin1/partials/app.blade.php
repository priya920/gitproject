...
<html lang="en">
  <head>
    ...
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="backend1/css/main.css">
    <!-- Font-icon css-->
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  </head>
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
   @include('admin1.partials.header')
    <!-- Sidebar menu-->
     @include('admin1.partials.sidebar')
    <main class="app-content">
       @yield('content')
       @include('admin1.partials.Monthly Sales')
    ...
    <script src="backend1/js/jquery-3.2.1.min.js"></script>
    <script src="backend1/js/popper.min.js"></script>
    <script src="backend1/js/bootstrap.min.js"></script>
    <script src="backend1/js/main.js"></script>
